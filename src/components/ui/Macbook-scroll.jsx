  ...
  return (
    (<div
      ...
      <motion.h2
        ...
        className="dark:text-white text-neutral-800 text-8xl font-bold mb-20 text-center">
        {title || (
          <span>
  ...
  return (
    (<div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        <img src="https://images.pexels.com/photos/577585/pexels-photo-577585.jpeg?auto=compress&cs=tinysrgb&w=800" alt="this is an image" className="object-cover object-left-top absolute rounded-lg inset-0 h-full w-full"/>
      </motion.div>
    </div>)
  );
};
